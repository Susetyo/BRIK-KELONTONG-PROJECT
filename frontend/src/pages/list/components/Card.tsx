...
const Card = ({item}:TCard) => {
  ...
  return (
    <div onClick={onClick} className="flex justify-between flex-wrap gap-5 border-2 border-solid border-[#E1E1E1] p-2 rounded-md cursor-pointer hover:bg-slate-100 z-0">
